...
public class AdapterClubDyComp extends RecyclerView.Adapter<AdapterClubDyComp.Holder> {
    private Context context;
    private List<ClubDynamicComment> commentList;

    public AdapterClubDyComp(Context context){
        this.context = context;
    }

    public void setData(List<ClubDynamicComment> commentList){
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ClubDynamicComment comment = commentList.get(position);
    ...
    class Holder extends RecyclerView.ViewHolder{
        ...
        private ImageView iv_dp; //用户头像
        private TextView tv_username; //用户名
        private TextView tv_user_comment; //用户评论

        public Holder(View itemView) {
            super(itemView);
            iv_dp = (ImageView) itemView.findViewById(R.id.iv_dp);
